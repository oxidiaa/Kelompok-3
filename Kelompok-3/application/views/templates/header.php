  ...
  <body>
    ...
    <li class="sidebar-item">
        ...
        <a class="sidebar-link" href="<?= base_url('outlet'); ?>" aria-expanded="false">
            <span>
            <iconify-icon icon="solar:boombox-bold-duotone"  class="fs-6"></iconify-icon>
            </span>
        ...
        <a class="sidebar-link" href="<?= base_url('product'); ?>" aria-expanded="false">
            <span>
            <iconify-icon icon="solar:clapperboard-bold-duotone" class="fs-6"></iconify-icon>
            </span>
        ...
        <li class="sidebar-item">
        <a class="sidebar-link" href="<?= base_url('pembelianstok'); ?>" aria-expanded="false">
            <span>
            <iconify-icon class="fs-6" icon="solar:cart-plus-bold-duotone"></iconify-icon>
            </span>
            <span class="hide-menu">Barang Masuk</span>
        </a>
        </li>
        <li class="sidebar-item">
        <a class="sidebar-link" href="<?= base_url('penjualanstok'); ?>" aria-expanded="false">
            <span>
            <iconify-icon class="fs-6" icon="solar:cart-bold-duotone"></iconify-icon>
            </span>
          ...
          <li class="sidebar-item">
          <a class="sidebar-link" href="<?= base_url('karyawan'); ?>" aria-expanded="false">
              <span>
              <iconify-icon class="fs-6"></iconify-icon>
              </span>
